...
Tài liệu vận hành: [`docs/OBSERVABILITY.md`](docs/OBSERVABILITY.md), [`docs/PERFORMANCE.md`](docs/PERFORMANCE.md), quyết định bảo mật [`docs/adr/0001-security-boundaries.md`](docs/adr/0001-security-boundaries.md), quyết định routing supply-chain [`docs/adr/0002-supply-chain-routing.md`](docs/adr/0002-supply-chain-routing.md), quyết định agent fallback [`docs/adr/0003-agent-fallback-strategy.md`](docs/adr/0003-agent-fallback-strategy.md) và bản đồ gap/evidence [`docs/AUDIT_AND_GAP_ANALYSIS.md`](docs/AUDIT_AND_GAP_ANALYSIS.md).

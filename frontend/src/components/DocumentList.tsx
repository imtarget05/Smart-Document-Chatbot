...
function DocumentList({
  ...
  const deleteMutation = useMutation({
    ...
    onError: (error) => {
      ...
      alert('Failed to delete document. Please make sure the service is running.');
    }
  });
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-xs font-bold text-gray-400 uppercase tracking-wider">Documents</h3>
